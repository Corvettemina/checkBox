...
def index():
    ...
    response = requests.get('https://192.81.219.24:8080/home')
    ...
    if form.validate_on_submit():
        ...
        postResponse = requests.post('https://192.81.219.24:8080/date?date=' + str(session['startdate']))
...
if __name__ == "__main__":
    ...
    app.run(host='0.0.0.0',ssl_context=('/root/localhost.crt','/root/localhost.key'))
